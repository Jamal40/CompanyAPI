...
namespace CompanyAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(@"server=.\SQLEXPRESS; initial catalog=CompanyDatabase; integrated security=true;");
            });
            services.AddDbContext<AuthorizationDbContext>(options =>
            {
                options.UseSqlServer(@"server=.\SQLEXPRESS; initial catalog=CompanyDatabaseAuth; integrated security=true;");
            });
